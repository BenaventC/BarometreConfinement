...
write_rds(tweets,"df_consoj22.rds")
...
df_22<-rbind(df1_8,df9,df10,df11,df121314,df15,df15b,df15c,df16,df17,df18,df1920,df21,df22) %>% select(user_id,status_id,created_at,screen_name,text,source,display_text_width,is_quote,is_retweet,favorite_count,retweet_count,quote_count,reply_count, media_type, lang, followers_count)
write_rds(df_22,"df_22.rds")

sample<-readRDS(file="df_22.rds")
...
ts_plot(df_22, "1 hours", color="darkblue") +
