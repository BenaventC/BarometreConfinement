...
write_rds(tweets,"df_consoj19b.rds")
#rattapper le j19
...
df_24<-rbind(df1_8,df9,df10,df11,df121314,df15,df15b,df15c,df16,df17,df18,df19b,df1920,df21,df22,df23,df24) %>% select(user_id,status_id,created_at,screen_name,text,source,display_text_width,is_quote,is_retweet,favorite_count,retweet_count,quote_count,reply_count, media_type, lang, followers_count)
write_rds(df_24,"df_24.rds")
...
```{r desc1}
df_24<-readRDS(file = "df_24.rds")

## plot time series of tweets
ts_plot(df_24, "3 hours", color="darkblue") +
