...
### Elements communs aux approches multicore et cluster
...
#### READ & UPDATE: données
Après avoir chargé les données collectées, 
...
#### CHUNK SIZE:
determination de la taille des segments de tweets pour les split en fonction de leur nombre et du nombre de noeuds disponibles.
