...
Les scripts proposés cherchent à accélérer les calculs d'annotation car cela sont les plus lourds et constituent un goulot d'étranglement a ce stade des analyses. 
...
Comme c'est ici que se concentre les calculs lourds nous y ajouté une fonctionalité (system.time) qui calcule leur durée 
...
La fonction slurm_apply est un genre d'envoppe pour mclapply du package parallel et dispatch les memes opérations sur le cluster d'ordinateurs  
